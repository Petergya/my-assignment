...
function Hero() {
  return (
    <section className="relative w-full h-screen py-10 lg:py-16 bg-[url('/images/hero.jpeg')] bg-cover bg-center">
      ...
      {/* Sidebar */}
      <div className="absolute top-0 left-0 h-full w-64 bg-black p-6  flex-col justify-center hidden md:block"> 
  ...
  <div className="w-full  text-white flex flex-col justify-start items-start"> 
    <h1 className="font-semibold text-2xl lg:text-4xl leading-normal text-left mt-32 ">
